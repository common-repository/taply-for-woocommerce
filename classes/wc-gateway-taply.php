...
class WC_Gateway_Taply extends WC_Payment_Gateway {
    ...
    public function __construct() {
        ...
        $this->method_description = __('Taply enables e-commerce websites to accept Apple Pay<sup>&reg;</sup>. It’s easy, quick and secure for both your business and your customers. Install the taply plugin to accept Apple Pay<sup>&reg;</sup> on your website now. Register your taply account at https://portal.taplycheckout.com/signup.html. <br><br><b>Set Success Page in your store settings to ' . $strSuccessUrl . '</b>', 'taply-for-woocommerce');
...
//        }
        ...
        $this->form_fields = array(
            'merchant_id' => array(
                ...
                'type' => 'text',
                'description' => __('Create Taply accounts and obtain merchant id from within your <a href="http://taplycheckout.com">Taply merchant account</a>.', 'taply-for-woocommerce'),
                'default' => ''
            ),
            ...
            'view_type' => array(
                ...
                'label' => __('How to display Taply block.', 'taply-for-woocommerce'),
                'description' => __('Set how to display the Taply button.', 'taply-for-woocommerce'),
                'type' => 'select',
                'options' => array(
            ...
            'button_position' => array(
                ...
                'label' => __('Where to display Taply button.', 'taply-for-woocommerce'),
                'description' => __('Set where to display the Taply block.'),
                'type' => 'select',
                'options' => array(
            ...
            'show_on_cart' => array(
                ...
                'label' => __('Show Taply button on shopping cart page.', 'taply-for-woocommerce'),
                'type' => 'checkbox',
                'default' => 'yes'
            ),
            'show_on_product_page' => array(
                ...
                'type' => 'checkbox',
                'label' => __('Show Taply button on product detail pages.', 'taply-for-woocommerce'),
                'default' => 'no',
    ...
    static function getButtonCode($arrCart, $strType){
        ...
        <?php } else { ?>
            <div class="module pay-module taply-block" data-cart='<?php echo htmlspecialchars(json_encode($arrCart), ENT_QUOTES, 'UTF-8'); ?>'  data-type="cart" data-view-type="popup">
                <a href="#" class="taply-apply-pay taply-btn">&nbsp;</a>
            </div>
        <?php } 
    }
