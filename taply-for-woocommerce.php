 ...
 * Plugin URI:        http://www.taplycheckout.com/plugin
 ...
 * Version:           2.0.0
 * Author:            Taply
 * Author URI:        http://www.taplycheckout.com/
...
if(!class_exists('DS_Taply')){
    class DS_Taply
    {
        ...
        function woocommerceTaplyInitStyles() {
            global $dst_settings;
            wp_register_script( 'taply_button', 'https://www.taplycheckout.com/js/taply.1.2.js' , array( 'jquery' ), WC_VERSION, true );
            if ( ! is_admin()){
